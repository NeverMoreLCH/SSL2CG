...
#-----------------------------------------------------
# Sample
cfg.DATASET.SAMPLE = edict()
# Neg
cfg.DATASET.SAMPLE.NEG = edict()
cfg.DATASET.SAMPLE.NEG.MASK_MODE = None
cfg.DATASET.SAMPLE.NEG.BATCH_WEIGHT = None
cfg.DATASET.SAMPLE.NEG.Q_PARAMS = edict()
cfg.DATASET.SAMPLE.NEG.V_PARAMS = edict()

# Pos
cfg.DATASET.SAMPLE.POS = edict()
cfg.DATASET.SAMPLE.POS.MASK_MODE = None
cfg.DATASET.SAMPLE.POS.BATCH_WEIGHT = None
cfg.DATASET.SAMPLE.POS.Q_PARAMS = edict()
cfg.DATASET.SAMPLE.POS.V_PARAMS = edict()
#-----------------------------------------------------
...
cfg.LOSS = edict()
cfg.LOSS.ORI = edict()
cfg.LOSS.ORI.NAME = None
cfg.LOSS.ORI.PARAMS = None
cfg.LOSS.NEG = edict()
cfg.LOSS.NEG.NAME = None
cfg.LOSS.NEG.PARAMS = None
cfg.LOSS.POS = edict()
cfg.LOSS.POS.NAME = None
cfg.LOSS.POS.PARAMS = None
cfg.LOSS.CONTRAST = edict()
cfg.LOSS.CONTRAST.NAME = None
cfg.LOSS.CONTRAST.PARAMS = None
#-----------------------------------------------------
